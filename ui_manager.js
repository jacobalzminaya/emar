// ui_manager.js - VERSIÓN V8.7 FINAL + updateStretchUI (SIN ERRORES DE SINTAXIS)
const UIManager = {
    ...
    // Función agregada para corregir el error: UIManager.updateStretchUI is not a function
    updateStretchUI(warningText = "", color = "#ffaa00") {
        ...
        if (warningText.trim() !== "") {
            ...
            stretchEl.style.fontWeight = 'normal';
        }
    },
